    ...
    <section class="article">
        ...
        <div class="infos">
            <div class="infos__meta">
                <p class="infos__meta--categorie"><?php dw_the_category(', ', '<strong class="post_place post_place--:type">', '</strong>'); ?></p>
                <p class="infos__meta--date"><time class="date__post" datetime="<?php the_time('c'); ?>"><?php the_time('l, j F'); ?></time></p>
                <p class="infos__meta--auteur"><?php _e('Auteur','wp');?> : <span><?php the_field('auteur'); ?></span></p>
