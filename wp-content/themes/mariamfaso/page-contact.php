...
<main class="main">
    ...
    <section class="cont">
        <h2 class="main__heading2" aria-level="2" role="heading"><?php _e('Formulaire de contact', 'dw') ?></h2>
        ...
        <div class="links">
            ...
            <div class="CTA">
                <h3 class="main__heading3" aria-level="3" role="heading"><?php _e('Autre chose', 'dw') ?> ?</h3>
                <ul class="list">
                    <li class="list__elt">
