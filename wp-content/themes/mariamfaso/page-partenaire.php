...
<main class="main">
    ...
    <section class="collab">
        <h2 class="main__heading2" aria-level="2" role="heading"><?php _e('Demande de partenaria','wp');?></h2>
        <form action="post" class="form">
            <!-- <div class="cond">
                <a href="../docs/partenariacondition.pdf" title="Aller vers le fichier des condition de partenaria" class="form__cond"><?php _e('Lire les conditions de partenaria','wp');?></a>
            </div> -->
        ...
        <div class="links">
            <div class="contact">
                ...
                <ul class="list">
                    <li class="list__elt">
                        <a href="<?php the_field('tel1', 48); ?>" class="list__link" title="Telephoner au numero <?php the_field('tel1', 48); ?>">Tél. : <span><?php the_field('tel1', 48); ?></span></a>
                    </li>
            ...
            <div class="CTA">
                ...
                <ul class="list">
                    <li class="list__elt">
                        <a href="<?php the_permalink(46); ?>" title="Aller vers la page de <?php get_the_title(46); ?>." class="list__elt--link">Une question ?</a>
                    </li>
                    <li class="list__elt">
                        <a href="<?php the_permalink(44); ?>" title="Aller vers la page de <?php get_the_title(44); ?>." class="list__elt--link">Partir avec nous ?</a>
                    </li>
                    <li class="list__elt">
                        <a href="<?php the_permalink(50); ?>" title="Aller vers la page de <?php get_the_title(50); ?>." class="list__elt--link">Établir un partenaria ?</a>
                    </li>
                </ul>
            </div>
        </div>
